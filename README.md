...
AWS Marketplace SageMaker model package. This repository contains the CloudFormation
templates and example notebooks you need to deploy it as a **real-time endpoint** or a
**batch transform job**.
...
Template in this repo: [`cf/template-marketplace-realtime.json`](cf/template-marketplace-realtime.json)
...
Template in this repo: [`cf/template-marketplace-batch-transform.json`](cf/template-marketplace-batch-transform.json)
...
| Notebook | Purpose |
|---|---|
| [`notebooks/realtime_endpoint.ipynb`](notebooks/realtime_endpoint.ipynb) | Invoke the real-time endpoint with a medical image and read the response. |
| [`notebooks/batch_transform.ipynb`](notebooks/batch_transform.ipynb) | Upload a JSONL batch request, launch a batch transform job, and read the output. |

A sample input image is provided at [`notebooks/inputs/chest_xray.png`](notebooks/inputs/chest_xray.png).
...
└── README.md                                 This guide (also the docs-site home page)
```
